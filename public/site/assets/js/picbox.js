!function (a, b) {
    ...
    !function () {
        ...
        d.prototype.init = function () {
            ...
            if ("X" === b) {
                ...
                if (0 === a || 180 === a) f = 1; else if (90 === a) {
                    var i = parseFloat(e[1]), j = parseFloat(e[2]);
                    f = Math.sign(i * j * d * h)
                }
                f *= h
            }
            ...
            var c = a.originalEvent.targetTouches[0].pageX, d = a.originalEvent.targetTouches[0].pageY;
            ...
            c.core.$slide.on("mousedown.lg.zoom", function (e) {
                ...
                var g = c.core.$slide.eq(c.core.index).find(".lg-object"), k = c.getDragAllowedAxises(g, Math.abs(j));
            ...
            var f = this, g = f.core.$slide.eq(f.core.index).find(".lg-img-wrap"),
    ...
    !function () {
        "use strict";
        var b = {rotate: !0, rotateLeft: !0, rotateRight: !0, flipHorizontal: !0, flipVertical: !0}, c = function (c) {
        ...
        c.prototype.buildTemplates = function () {
            ...
            var a = this.core.$slide.eq(this.core.index).find(".lg-img-rotate")[0], b = this.getCurrentRotation(a),
                c = "flipHorizontal";
